...
- DNS and Mail (Postfix, Dovecot)
- Databases (MySQL, MariaDB)
- SSL, TLS, and PKI
- Log Analysis (journalctl, panel.log)
- Monitoring (360 Monitoring, Grafana, atop)
...
- Security Incident Response (Malware, DDoS)
- Disaster Recovery (RTO, RPO)
- AI Enablement, RAG, Prompt Engineering
...
Apr 2020 to Aug 2020 · Brazil · Remote

- Supported Epic Games Store, Fortnite, and 2K Games.
